<template>
  <div class="profile-page" :class="{ 'dark-mode': isDarkMode }">
   ...
   minHeight: '100vh',
   padding: '4rem 2rem'
 }, isDarkMode ? { backgroundColor: '#0d2d1e' } : {}]">
       <!-- Toast -->
     ...
     Dark Mode
       ...
       <section>
         <div class="container py-5">
           ...
           <div :class="['card shadow p-4', isDarkMode ? 'background-dark' : 'background-light']">
             <!-- Profile Header -->
             <div class="text-center mb-4">
               ...
               <h4 class="mt-3 mb-1">{{ userData.name || 'Your username' }}</h4>
 ...
 <script>
 import lightBg from '@/assets/profileBackground.png';
 import darkBg from '@/assets/profileBackgroundDark.png';
 ...
 export default {
   ...
   isDarkMode.value ? darkBg : lightBg
 );
 ...
 .background-dark {
   background-color: #0d2d1e !important; /* your deep green */
   color: white; /* optional: to make sure text stays readable */
 }
...
.background-dark {
  background-color: #0d2d1e !important;
  color: white;
}
